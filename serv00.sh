...
download_and_run_singbox() {
  ...
  if [ "$ARCH" == "arm" ] || [ "$ARCH" == "arm64" ] || [ "$ARCH" == "aarch64" ]; then
      ...
      FILE_INFO=("https://github.com/yonggekkk/Cloudflare_vless_trojan/releases/download/serv00/sb web" "https://github.com/gtcock/demo/releases/download/cock/server-freebsd-amd64 bot")
  else
